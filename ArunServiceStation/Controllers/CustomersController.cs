...
namespace ArunServiceStation.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,VehicleNumber,MobileNumber,Email,Category,Provider,Timeslot")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,VehicleNumber,MobileNumber,Email,Category,Provider,Timeslot")] Customer customer)
        {
            if (ModelState.IsValid)
            {
